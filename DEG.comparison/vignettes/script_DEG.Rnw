...
\author{Project ID: RNAseq1_Jun2015 \\
	Project PI: Thomas Girke (thomas.girke@ucr.edu)\\
        Author of Report: Daniela Cassol (danicassol@gmail.com)}
\maketitle
...
The \Rpackage{DEG.comparison} package needs to be loaded to perform the analysis steps shown in this report \citep{Girke2014-oy}. 
